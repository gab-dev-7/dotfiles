...
<div class="grid">
    <img src="h1.png" alt="Desktop Screenshot" style="border-radius: 8px; border: 1px solid #1e293b;">

    <img src="h2.png" alt="Terminal Workflow" style="border-radius: 8px; border: 1px solid #1e293b;">

    <img src="h3.png" alt="Desktop Screenshot" style="border-radius: 8px; border: 1px solid #1e293b;">

    <img src="h4.png" alt="Terminal Workflow" style="border-radius: 8px; border: 1px solid #1e293b;">
